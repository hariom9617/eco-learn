...
-- Insert sample data
INSERT INTO public.profiles (user_id, display_name, role, points, streak) VALUES 
('00000000-0000-0000-0000-000000000001', 'Alex Johnson', 'student', 2850, 7),
('00000000-0000-0000-0000-000000000002', 'Sarah Wilson', 'teacher', 0, 0);

INSERT INTO public.courses (id, title, description, teacher_id, difficulty, duration_hours) VALUES 
('11111111-1111-1111-1111-111111111111', 'Climate Change Basics', 'Learn the fundamentals of climate science and environmental impact', '00000000-0000-0000-0000-000000000002', 'beginner', 8),
('22222222-2222-2222-2222-222222222222', 'Renewable Energy Systems', 'Explore solar, wind, and other sustainable energy sources', '00000000-0000-0000-0000-000000000002', 'intermediate', 12);

INSERT INTO public.modules (course_id, title, content, order_index, points_reward) VALUES 
('11111111-1111-1111-1111-111111111111', 'Introduction to Climate Change', 'Understanding the greenhouse effect and global warming...', 1, 10),
('11111111-1111-1111-1111-111111111111', 'Impact on Ecosystems', 'How climate change affects wildlife and natural habitats...', 2, 15),
('22222222-2222-2222-2222-222222222222', 'Solar Power Fundamentals', 'How photovoltaic cells convert sunlight into electricity...', 1, 20);

INSERT INTO public.eco_quests (title, description, points_reward, difficulty, created_by) VALUES 
('Plant a Tree Challenge', 'Plant a tree in your community and share a photo', 100, 'easy', '00000000-0000-0000-0000-000000000002'),
('Waste Audit', 'Conduct a 7-day waste audit of your household', 150, 'medium', '00000000-0000-0000-0000-000000000002'),
('Renewable Energy Research', 'Research and present on a renewable energy project in your area', 200, 'hard', '00000000-0000-0000-0000-000000000002');